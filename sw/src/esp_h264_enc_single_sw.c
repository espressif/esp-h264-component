...
esp_h264_err_t esp_h264_enc_sw_new(const esp_h264_enc_cfg_sw_t *cfg, esp_h264_enc_handle_t *out_enc)
{
    ...
    ESP_H264_RET_ON_FALSE((cfg->pic_type == ESP_H264_RAW_FMT_YUV422) || (cfg->pic_type == ESP_H264_RAW_FMT_I420), ESP_H264_ERR_ARG, TAG, "Un-supported h264 picture type parameter");
